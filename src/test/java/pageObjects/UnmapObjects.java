...
public class UnmapObjects {
	...
	@FindBy(xpath = "//*[contains(@class,'e6se2  ')]")
	WebElement unmapBtn;
...
//	WebElement popMessage;
	...
	@FindBy(xpath = "(//*[contains(@class,'__thDbe')])[1]")
	WebElement unassignIndividualBtn;
	
	@FindBy(xpath = "//*[contains(text(),'Unassign Employee From Campus ')]")
...
//	WebElement partialUnassignOption;
	...
	@FindBy(xpath = "//*[contains(@class,'m__x44p- ')]")
